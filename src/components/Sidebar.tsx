    ...
    <div className="flex h-full bg-[#1e293b] border-r border-slate-700/50">
      ...
      <div className="flex-1 flex flex-col w-[280px] sm:w-[300px]">
        ...
        <div className="p-6 pb-2 pt-2 md:pt-6">
          ...
          <button 
            onClick={onUpload}
            className="w-full mt-4 font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-lg bg-blue-600 hover:bg-blue-500 text-white shadow-blue-900/20"
          >
            <Upload size={18} />
